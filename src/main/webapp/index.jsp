...
<div class="container-fluid text-center">
    <div class="row content">
        ...
        <div class="col-sm-8 text-justify">
            ...
            <h2>О йоге</h2>
            <p> Чем же отличается йога от физкультуры?</p>
            <p>  Что нужно знать начинающим заниматься йогой в домашних условиях?

                Занятия йогой имеют свои особенности. Существует ряд нюансов, которые отличают йогу от других видов
                тренировок. </p>
                <p>Осознанность. Занятие йогой обычно начинается с пятиминутной медитации. Сядьте с прямой
                спиной как вам
                ...
                обычно сочетаются с медитацией. </p>
                <p>Работа с дыханием. Основа йоги — управление дыханием. Когда вы осознаёте своё дыхание и начинаете
