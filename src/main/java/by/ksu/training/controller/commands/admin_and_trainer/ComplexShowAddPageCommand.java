 ...
 * @Date 27.01.2021
 */
public class ComplexShowAddPageCommand extends AdminAndTrainerCommand {
    private static Logger logger = LogManager.getLogger(ComplexShowAddPageCommand.class);
