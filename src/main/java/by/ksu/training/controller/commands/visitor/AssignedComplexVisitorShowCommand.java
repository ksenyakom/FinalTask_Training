 ...
 * @Date 17.01.2021
 */
public class AssignedComplexVisitorShowCommand extends VisitorCommand {
    private static Logger logger = LogManager.getLogger(AssignedComplexVisitorShowCommand.class);
