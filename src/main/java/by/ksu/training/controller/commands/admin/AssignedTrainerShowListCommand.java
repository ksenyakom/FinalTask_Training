 ...
 * @Date 19.01.2021
 */
public class AssignedTrainerShowListCommand extends AdminCommand {
    private static Logger logger = LogManager.getLogger(AssignedTrainerShowListCommand.class);
