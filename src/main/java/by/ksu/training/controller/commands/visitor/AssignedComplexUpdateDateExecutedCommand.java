 ...
 */
public class AssignedComplexUpdateDateExecutedCommand extends VisitorCommand {
    private static Logger logger = LogManager.getLogger(AssignedComplexUpdateDateExecutedCommand.class);
