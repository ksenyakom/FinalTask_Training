 ...
 * @Date 23.01.2021
 */
public class ExerciseListShowCommand extends AdminAndTrainerCommand {
    private static Logger logger = LogManager.getLogger(ExerciseListShowCommand.class);
    ...
    protected ResponseState exec(HttpServletRequest request, HttpServletResponse response) throws PersistentException {
        ...
        if (page == null) {
            page = (String)request.getAttribute("currentPage");
        }
        int currentPage;
        if (page == null) {
            currentPage = 1;
