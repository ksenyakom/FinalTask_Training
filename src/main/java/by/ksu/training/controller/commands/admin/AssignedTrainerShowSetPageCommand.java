 ...
 * @Date 19.01.2021
 */
public class AssignedTrainerShowSetPageCommand extends AdminCommand {
    private static Logger logger = LogManager.getLogger(AssignedTrainerShowSetPageCommand.class);
