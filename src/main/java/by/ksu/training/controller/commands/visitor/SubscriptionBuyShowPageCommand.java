 ...
 * @Date 18.01.2021
 */
public class SubscriptionBuyShowPageCommand extends VisitorCommand {
    private static Logger logger = LogManager.getLogger(SubscriptionBuyShowPageCommand.class);
