 ...
 * @Date 27.01.2021
 */
public class ExerciseInComplexAddCommand extends AdminAndTrainerCommand {
    private static Logger logger = LogManager.getLogger(ExerciseInComplexAddCommand.class);
